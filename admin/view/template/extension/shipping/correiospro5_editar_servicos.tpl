...
<h3 class="panel-title"><i class="fa fa-edit"></i> Editar Servi&ccedil;os</h3>
</div>
<div class="panel-body">

<form method="post" action="<?php echo $salvar_editar_servico;?>" class="form-horizontal">
...
<?php foreach ($lista_servicos->rows as $servicol) { ?>
<option value="<?php echo $servicol['id_servico']; ?>"><?php echo $servicol['id_servico']; ?> - <?php echo $servicol['nome']; ?> <?php echo ($servicol['suporte_offline'])?'(Suporta Offline)':''; ?></option>
<?php } ?>
</select>
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="nome" value="<?php echo $servico['titulo'];?>" placeholder="Ex: PAC" class="form-control" required />
...
<div class="col-sm-10">
<input type="text" name="prazo_extra" value="<?php echo $servico['prazo_extra'];?>" class="form-control" />
...
<div class="col-sm-10">
<input type="text" name="valor_extra" value="<?php echo $servico['valor_extra'];?>" class="dinheiro form-control" />
...
<option value="0"<?php echo($servico['real_porcentagem']==0)?' selected':'';?>>Acrescimo Real - R$</option>
<option value="1"<?php echo($servico['real_porcentagem']==1)?' selected':'';?>>Acrescimo Porcentagem - %</option>
<option value="2"<?php echo($servico['real_porcentagem']==2)?' selected':'';?>>Desconto Porcentagem - %</option>
<option value="3"<?php echo($servico['real_porcentagem']==3)?' selected':'';?>>Desconto Real - R$</option>
</select>
</div>
</div>

<input type="hidden" name="peso_maximo" value="<?php echo $servico['peso_maximo'];?>" class="dinheiro form-control" />
<input type="hidden" name="total_maximo" value="<?php echo $servico['total_maximo'];?>" class="dinheiro form-control" />

<div class="form-group">
<label class="col-sm-2 control-label" for="input">Min. Desconto</label>
<div class="col-sm-10">
<input type="text" name="minimo" value="<?php echo $servico['total_minimo'];?>" class="dinheiro form-control" />
...
<div class="col-sm-10">
<textarea placeholder="" name="ceps" class="form-control"><?php echo $servico['ceps'];?></textarea>
...
<div class="col-sm-10">
<input type="text" name="minimo_frete" value="<?php echo $servico['total_minimo_frete'];?>" class="dinheiro form-control" />
...
<div class="col-sm-10">
<textarea placeholder="" name="ceps_excluir" class="form-control"><?php echo $servico['ceps_excluir'];?></textarea>
